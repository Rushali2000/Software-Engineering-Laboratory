...
<div class="card mt-4">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(url('admin/add-post')); ?>" method="POST">
            <?php echo csrf_field(); ?>   <!-- this token is used to verify that the authenticated user is the person actually making the requests to the application -->
            ...
            <div class="mb-3">
                ...
                <select name="category_id" required class="form-control">
                    ...
                    <!-- under value we are storing the category id -->
            ...
            <label for="">Description</label>
                <textarea name="description" class="form-control" rows="4"><?php echo e($post->description); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp new4\htdocs\SE Lab Project\volunteer_blog\resources\views/admin/post/edit.blade.php ENDPATH**/ ?>