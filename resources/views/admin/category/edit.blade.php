...
<div class="container-fluid px-4">
    ...
    <div class="card mt-4">
        ...
        <form action="{{ url('admin/update-category/'.$category->id) }}" method="POST" enctype="multipart/form-data">         <!-- enctype="multipart/form-data" -> important to upload any file type or image -->
            @csrf
            @method('PUT')
