                    ...
                    <div class="card-body">
                        <form method="POST" action="complaintInsert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="complaint" class="form-control @error('complaint') is-invalid @enderror" name="complaint" required autocomplete="complaint" rows="4">{{ old('complaint') }}</textarea>
